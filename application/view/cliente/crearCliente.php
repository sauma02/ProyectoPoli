                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-label-left input_mask" method="POST">
                                    ...
                                    <div class="col-md-6 col-sm-6  form-group has-feedback">
                                        <select name="txtDescripcion" id="txtDescripcion" class="form-control has-feedback-left">
                                            <option selected="selected">Tipo Cliente</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 col-sm-9 ">
                                            <input type="text" class="form-control" placeholder="Escribir Direccion" name="txtDireccion">
                                        </div>
                                    </div>
